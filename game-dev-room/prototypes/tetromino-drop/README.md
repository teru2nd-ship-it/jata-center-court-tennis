...
ボットン、BOTTOM、BUTTONを重ねた落ち物パズルのプレイ可能サンプル。
...
- 良いスコア用の動画は `assets/results/` に追加する。
